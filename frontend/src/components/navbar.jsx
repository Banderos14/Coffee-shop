...
const Navbar = () => {
  return (
    <div className="relative flex flex-col items-center gap-8 mb-[60px]">
        {/* Block over navbar */}
        <div className="w-full bg-[#ffecb8] border-b border-green-900/10 px-1 py-1.5 flex items-center relative">    
         ...
         {/* Navbar */}
         <div className="relative t-3 bg-[#1d4e1a] rounded-full flex justify-start items-center gap-10">
